...
tiles = [
 ...
 dict(n=2, slug="holiday-2026", img="t2.png", pos="50% 62%", h="Planning holiday gifts? Start here.", s="The best ones are planned early.", cta="Holiday gifting", logo=True),
...
.logo{{height:52px}} .logo img{{height:52px;width:auto;display:block}}
h1{{margin-bottom:26px;font-family:'Cormorant Garamond',Georgia,serif;font-weight:500;font-size:{hs}px;line-height:1.0;letter-spacing:-0.01em;margin:0 0 22px 0}}
